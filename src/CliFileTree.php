...
class CliFileTree extends Command
{
  ...
  */
  public function startFileMenu()
  {
    ...
    $menu->setTitle('Select a ' . $file_types . ' file')
    ->setTitleSeparator('')
  ...
  public function selectItem(CliMenu $menu)
  {
    ...
    if($target == ".") {
      ...
      if(@is_dir($this->currentdir . '/' . $target)) {
        ...
        $this->selectedFile = $this->currentdir . '/' . $menu->getSelectedItem()->getText();
        $this->menu->close();
      }
    }
  }
